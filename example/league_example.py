...
if __name__ == "__main__":
    ...
    league: League = LeagueAPIClient.get_league(league_id="949398245464334336")
    ...
    traded_picks: list[TradedPick] = LeagueAPIClient.get_traded_picks(league_id="949398245464334336")
